...
BOOL TestApp::InitInstance()
{
    ...
    {
        CString msg = CString("Command Line Usage:- -f FILE_PATH -w WIDTH -h HEIGHT\n\n\nExample:- ")+
                      m_pszAppName+CString(".exe -f test.yuv -w 1280 -h 720");
    ...
    m_pMainWnd->CreateEx(0, cs, CString("Harris Corner Detection - "+fpath), WS_OVERLAPPEDWINDOW, xpos, ypos, width, height, 0, 0);

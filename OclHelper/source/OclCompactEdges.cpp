...
const char CompactEdges::sSource[] = OCL_PROGRAM_SOURCE(
...
CompactEdges::CompactEdges(cl::Context& ctxt, cl::CommandQueue& queue)
    :mContext(ctxt),
     mQueue(queue),
     mScanBlkSize(256),
     mReduceBlkSize(64),
...
void CompactEdges::init(int warp_size)
{
...
void CompactEdges::createIntBuffer(size_t buffSize)
{
    size_t memSize = 0;
...
size_t CompactEdges::process(const cl::Image& inpImage, Ocl::DataBuffer<Ocl::Pos>& out, float value, size_t& outCount)
{
    size_t width, height;
